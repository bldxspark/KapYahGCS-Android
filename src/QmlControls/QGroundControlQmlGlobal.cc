...
connect(&_flightMapPositionSettledTimer, &QTimer::timeout, this, []() {
...
{
#ifdef QT_DEBUG
QList sharedLinks = LinkManager::instance()->links();
...
{
return QStringLiteral("KapYah Ground Control Station");
}
