...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonBorder,         "#C90E19", "#C90E19", "#C90E19", "#C90E19")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#333333", "#A6A6A6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight,      "#C90E19", "#C90E19", "#C90E19", "#C90E19")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#2c2c2c", "#ffffff")
    DECLARE_QGC_COLOR(primaryButton,        "#C90E19", "#C90E19", "#C90E19", "#C90E19")
    DECLARE_QGC_COLOR(primaryButtonText,    "#ffffff", "#ffffff", "#707070", "#ffffff")
    ...
    DECLARE_QGC_COLOR(groupBorder,          "#bbbbbb", "#000000", "#707070", "#707070")
